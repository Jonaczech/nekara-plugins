...
public final class FishingListener implements Listener {
    ...
    public FishingListener(NekaraRPGPlugin plugin, FishingMinigameManager manager) {
        this.plugin = plugin;
    ...
    private boolean hasFishingPermission(Player player) {
        return player.hasPermission("nekararpg.use") || player.hasPermission("nekarafishing.use");
    }

    private boolean hasBypassPermission(Player player) {
        return player.hasPermission("nekararpg.bypass") || player.hasPermission("nekarafishing.bypass");
    }
}
